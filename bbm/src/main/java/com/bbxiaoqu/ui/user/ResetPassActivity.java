...
public class ResetPassActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_verf.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				{
					Toast.makeText(ResetPassActivity.this, "请填写电话号码", Toast.LENGTH_LONG);
					return;
				}
		...
		register_btn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				if(pass.equals(""))
				{
					Toast.makeText(ResetPassActivity.this, "请填写用户密码", Toast.LENGTH_LONG);
					return;
				}
				if(tlephone.equals(""))
				{
	...
	Handler savehandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if (result == 1) {
				Toast.makeText(ResetPassActivity.this, "保存成功",Toast.LENGTH_SHORT).show();
				
				UserService uService = new UserService(ResetPassActivity.this);
				User user = new User();
				...
				Toast.makeText(ResetPassActivity.this, "注册成功", Toast.LENGTH_LONG).show();
				
				Intent intent = new Intent(ResetPassActivity.this,LoginActivity.class);
				startActivity(intent);
			}else if (result == 2) {
				Toast.makeText(ResetPassActivity.this, "用户ID已注册",Toast.LENGTH_SHORT).show();
			}else if (result == 3) {
				Toast.makeText(ResetPassActivity.this, "手机号已注册",Toast.LENGTH_SHORT).show();
			} else if (result == 4) {
				Toast.makeText(ResetPassActivity.this, "验证码不正确",Toast.LENGTH_SHORT).show();
			} else {
				Toast.makeText(ResetPassActivity.this, "保存失败",Toast.LENGTH_SHORT).show();
			}
		}
	};
