...
import com.bbxiaoqu.ui.fragment.PublishFragment.GalleryIndexAdapter;
...
public class SubscribeFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View newsLayout = inflater.inflate(R.layout.fragment_subscribe_layout, container,
				false);
		
		myGallery = (DetailGallery)newsLayout.findViewById(R.id.myGallery);
		gallery_points = (RadioGroup) newsLayout.findViewById(R.id.galleryRaidoGroup);

		
		publish_btn_0=(Button) newsLayout.findViewById(R.id.subscribe_btn_0);
		publish_btn_1=(Button) newsLayout.findViewById(R.id.subscribe_btn_1);
		publish_btn_0.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(getActivity(),SubscribeCommunityMapActivity.class);
		...
		publish_btn_1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				//Intent intent=new Intent(getActivity(),AddInterestActivity.class);
				//startActivity(intent);
			}
		});
		init();
